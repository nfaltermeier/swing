...
namespace Swing.Engine.Actors.Particles
{
    public abstract class ParticleSystem : Actor
    {
        ...
        public override RenderType RenderType => blendState == BlendState.AlphaBlend ? RenderType.Standard : RenderType.Custom;
        ...
        public ParticleSystem(Vector2 position, int maxParticles) : base(position)
        {
        ...
        protected override void LoadContent(ContentManager contentManager)
        {
            ...
            if (spriteBatch == null) spriteBatch = MainGame.Instance.ScreenManager.SpriteBatch;
        ...
        protected override void Draw()
        {
            ...
            if(RenderType == RenderType.Custom)
                spriteBatch.Begin(blendState: blendState, samplerState: SamplerState.PointClamp, sortMode: SpriteSortMode.FrontToBack, transformMatrix: MainGame.Instance.StandardTransformMatrix, rasterizerState: RasterizerState.CullClockwise);
            ...
            foreach (Particle p in particles)
            {
                ...
                spriteBatch.Draw(texture, p.Position, null, p.Color,
                    p.Rotation, origin, p.Scale, SpriteEffects.None, RenderOrder.Particle);
            }
        ...
        protected void AddParticles(Vector2 where)
        {
            ...
            int numParticles =
                 Utilities.random.Next(minNumParticles, maxNumParticles);
        ...
        protected void AddParticles(Rectangle where)
        {
            ...
            for (int i = 0; i < numParticles && freeParticles.Count > 0; i++)
            {
                // grab a particle from the freeParticles queue, and Initialize it.
                int index = freeParticles.Dequeue();
                InitializeParticle(ref particles[index], Utilities.random.RandomPosition(where));
            }
        }
